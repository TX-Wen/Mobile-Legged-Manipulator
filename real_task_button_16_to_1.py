...
class CameraManager:
    ...
    def get_latest_frame(self):
        ...
        #rgb_image = Image.fromarray(bgr_image).convert("RGB")
    ...
    def preprocess_for_model(self, bgr_image, device):
        ...
        img = Image.fromarray(bgr_image).convert("RGB")
        ...
        rgb_float = np.array(resized_image).astype(np.float32) / 255.0
...
class PolicyModel:
    ...
    def __init__(self, checkpoint_path, device):
        ...
        stats_path = ("/home/baishan/diffusion_policy_real/data/global_norm_stats.json")            #需要给出具体地址
